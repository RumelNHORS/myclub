...
#Creat Admin Event Approval Page
def admin_approval(request):
	...
	if request.user.is_superuser:
		...
		messages.success(request,("You aren't authorize to view this page !"))
...
def venue_csv(request):
	...
	#loop Thu and Output
	for venue in venue:
		writer.writerow([venue.name, venue.address, venue.zip_code, venue.phone, venue.web_site, venue.email_address])
	return response
...
def delete_event(request, event_id):
	...
	if request.user == event.manager:
		...
		messages.success(request, ("You aren't Authorize To Delet This Event!"))
		return redirect('list_events')
...
def home(request, year=datetime.now().year, month=datetime.now().strftime('%B')):
	...
	#Queary The Events Model For Dates
